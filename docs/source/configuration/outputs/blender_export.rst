...
-  **options** :index:`: <pair: output - blender_export; options>`  [:ref:`Blender_ExportOptions parameters <Blender_ExportOptions>`] [:ref:`dict <dict>`] (default: empty dict, default values used) Options for the `blender_export` output.
