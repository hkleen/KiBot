...
-  **options** :index:`: <pair: output - copy_files; options>`  [:ref:`Copy_FilesOptions parameters <Copy_FilesOptions>`] [:ref:`dict <dict>`] (default: empty dict, default values used) Options for the `copy_files` output.
-  **type** :index:`: <pair: output - copy_files; type>` 'copy_files'
-  ``category`` :index:`: <pair: output - copy_files; category>` [:ref:`string <string>` | :ref:`list(string) <list(string)>`] (default: ``''``) [:ref:`comma separated <comma_sep>`] The category for this output. If not specified an internally defined
   category is used. |br|
