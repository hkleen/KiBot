...
-  **options** :index:`: <pair: output - ps_sch_print; options>`  [:ref:`PS_SCH_PrintOptions parameters <PS_SCH_PrintOptions>`] [:ref:`dict <dict>`] (default: empty dict, default values used) Options for the `ps_sch_print` output.
...
-  ``disable_run_by_default`` :index:`: <pair: output - ps_sch_print; disable_run_by_default>` [:ref:`string <string>` | :ref:`boolean <boolean>`] (default: ``''``) Use it to disable the `run_by_default` status of other output.
