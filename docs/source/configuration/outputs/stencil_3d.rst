...
-  **options** :index:`: <pair: output - stencil_3d; options>`  [:ref:`Stencil_3D_Options parameters <Stencil_3D_Options>`] [:ref:`dict <dict>`] (default: empty dict, default values used) Options for the `stencil_3d` output.
