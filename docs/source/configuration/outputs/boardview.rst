...
-  **options** :index:`: <pair: output - boardview; options>`  [:ref:`BoardViewOptions parameters <BoardViewOptions>`] [:ref:`dict <dict>`] (default: empty dict, default values used) Options for the `boardview` output.
