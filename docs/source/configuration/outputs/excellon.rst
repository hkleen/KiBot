...
-  **options** :index:`: <pair: output - excellon; options>`  [:ref:`ExcellonOptions parameters <ExcellonOptions>`] [:ref:`dict <dict>`] (default: empty dict, default values used) Options for the `excellon` output.
